...
export function GovernanceInterface({
  ...
  return (
    <div className="max-w-6xl mx-auto">
      {/* Header */}
      <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex-shrink-0">
            <div className="bg-white rounded-lg p-3 sm:p-4 border border-green-200">
              <div className="text-xs sm:text-sm text-gray-600 mb-1">Your Role</div>
              <div className="text-base sm:text-lg font-semibold text-green-600 capitalize">
                {userStatus.role}
              </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
        <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6">
          <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">NFT Collection</h3>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6">
          ...
          <div className="text-xs sm:text-sm text-gray-600">
            ...
            <div className="text-green-600 mt-1 text-xs sm:text-sm font-medium">✓ Active</div>
          </div>
        </div>

        <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6">
          <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Timelock</h3>
          <div className="text-xs sm:text-sm text-gray-600">
            <div className="font-mono text-xs break-all">
              {community.timelock.slice(0, 20)}...
            </div>
            <div className="text-blue-600 mt-1 text-xs sm:text-sm font-medium">⏱ Configured</div>
          </div>
        </div>
      </div>
